"""
Trilha 4 - Cria via API REST do N8N um workflow minimo:
Webhook -> busca amostra na API de diagnostico -> envia para diagnostico -> retorna resultado.
Mesmo padrao usado no projeto de teleoperacao de robo (Entregas - Yan Santos/n8n):
webhook recebe evento -> HTTP Request processa -> resposta.
"""
import os
...
workflow = {
    "name": "Harbor - Diagnostico Automatico de Sensor",
    "nodes": [
        {
            "parameters": {
                "httpMethod": "GET",
                "path": "diagnostico-automatico",
...
def main():
    ...
    print(f"\nWebhook disponivel em: {N8N_URL}/webhook/diagnostico-automatico")
