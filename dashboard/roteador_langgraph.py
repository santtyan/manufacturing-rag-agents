...
1. pede_interpretacao_recall -> "interpretacao_recall" (prioridade maxima, ver comentario
   original sobre a trava que impede o desempate por LLM de reclassificar essa pergunta)
2. pede_confirmacao_alarme_automatico -> "contexto"
3. pede_ranking_assets_duas_empresas -> "contexto"
4. pede_downtime_dataset_errado -> "contexto"
5. pede_matriz_confusao_precalculada -> "contexto"
6. rotear_por_keyword() -- que por sua vez checa, nesta ordem interna:
   6a. pede_cruzamento_categoria_x_periodo_lss -> "nao_respondivel_lss"
   6b. pede_roi_dado_inexistente -> "nao_respondivel_roi"
   6c. pede_cruzamento_ciclo_x_anomalia_cnc -> "nao_respondivel_cnc"
   6d. pede_planned_vs_unplanned -> "planned_vs_unplanned"
   6e. pede_lss_melhorou_tudo -> "lss_melhorou_tudo"
   6f. palavra-chave SQL ou pede_agregacao_com_filtro ou pede_ranking_categoria -> "sql"
   6g. palavra-chave RAG (sem sinal de dado calculado) -> "rag"
   6h. default -> "contexto"
